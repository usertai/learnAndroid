package com.example.he.imageloader;
...
import com.example.he.imageloader.loader.ImageLoader;
import com.example.he.imageloader.utils.MyUtils;
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.imageView = (ImageView) convertView.findViewById(R.id.image_);
