...
public class FocusScene {
    ...
    private IFocusSceneListener mISceneListenner;
    ...
    public static final String COMMIT_ACTION = "com.iflytek.xiri2.focusActivity.COMMIT";
    ...
    public FocusScene(Context context) {
        mContext = context;
        token = this.hashCode();
    ...
    public void init(IFocusSceneListener listenner) {
