package com.example.he.superadapter;
...
public class ViewHolder {
    ...
    public static ViewHolder getViewHolder(View contentView, ViewGroup parent, int position, int layoutId) {
        ViewHolder viewHolder;
        if (contentView == null) {
            contentView = LayoutInflater.from(parent.getContext()).inflate(layoutId, parent, false);
            viewHolder = new ViewHolder(parent.getContext(), contentView, position);
